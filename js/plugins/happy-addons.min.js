...
(c => {
    ...
    function d(e, t) {
        ...
        e.length && (e.on("click.onFilterNav", "button", function(e) {
            e.stopPropagation();
            e = c(this);
            e.addClass("ha-filter__item--active").siblings().removeClass("ha-filter__item--active"),
            t(e.data("filter"))
        }),
    ...
    function h(e) {
        ...
        c.fn.magnificPopup && (e.isEnabled ? (t = c(window).width(),
    ...
    function u(e) {
        ...
        }[n.move_handle || "on_swipe"]] = !0,
        delete n.move_handle,
        t.imagesLoaded().done(function() {
            t.twentytwenty(n);
            var e = setTimeout(function() {
                r.trigger("resize.twentytwenty"),
                clearTimeout(e)
            }, 400)
        })
    }
    ...
    r.on("elementor/frontend/init", function() {
        ...
        var t = elementorModules.frontend.handlers.Base
          , n = t.extend({
            ...
            getSlickSettings: function() {
                ...
                return t.slidesToShow = parseInt(this.getElementSettings("slides_to_show")) || 1,
                t.slidesToScroll = e && parseInt(this.getElementSettings("slides_to_show")) || 1,
                t.responsive = [{
          ...
          , a = t.extend({
            onInit: function() {
                ...
                this.run(),
                this.runFilter(),
                r.on("resize", l(this.run.bind(this), 100))
            },
          ...
          , o = t.extend({
            ...
            run: function() {
                var e, t, n, a, i, o, s, r;
                0 != this.wrapper.length && (a = this.wrapper.innerHeight(),
                r = this.wrapper.innerWidth(),
                t = (e = this.wrapper.find(".ha-news-ticker-container")).find(".ha-news-ticker-item"),
                a = "scroll" + (n = this.wrapper.data("scroll-direction")) + parseInt(a) + parseInt(r),
            ...
            run: function() {
                ...
                s.on(e, l(function(e) {
                    ...
                    var e = c(this)
                      ...
                      , o = !1;
                    0 === a.length && (s.removeClass("active"),
                    i.removeClass("active"),
                    e.addClass("active"),
                    i.each(function() {
                        var e = c(this)
                          , t = e.data("term");
                        n === t && (e.addClass("active"),
                        o = !0)
                    }),
                    !1 === o) && c.ajax({
                        ...
                        success: function(e) {
                            t.find(".ha-post-tab-loading").remove(),
                            t.append(e)
                        },
                        error: function(e) {}
                    })
        ...
        c("body").on("click.onWrapperLink", "[data-ha-element-link]", function() {
            var e, t, n = c(this), a = n.data("ha-element-link"), n = n.data("id"), i = document.createElement("a");
        ...
        c.each({
            ...
            "ha-twitter-feed.default": function(i) {
                ...
                e.on("click", function(e) {
                    ...
                    c.ajax({
                        ...
                        success: function(e) {
                            a < n ? c(e).appendTo(o) : (t.text("All Loaded").addClass("loaded"),
                            setTimeout(function() {
                                t.css({
                                    display: "none"
                                })
            ...
            "ha-threesixty-rotation.default": function(a) {
                var e, i = a.find(".ha-threesixty-rotation-inner"), t = i.data("selector"), n = i.data("autoplay"), o = a.find(".ha-threesixty-rotation-magnify"), s = a.find(".ha-threesixty-rotation-360img"), r = o.data("zoom"), l = a.find(".ha-threesixty-rotation-play"), d = circlr(t, {
                    play: !0
                });
                ...
                setTimeout(function() {
                    ...
                    e.preventDefault();
                    e = c(this).find("i");
                    e.hasClass("hm-play-button") ? (e.removeClass("hm-play-button"),
                    e.addClass("hm-stop"),
                    d.play()) : (e.removeClass("hm-stop"),
                ...
                o.on("click", function(e) {
                    a.find("img").each(function() {
                        -1 !== c(this).attr("style").indexOf("block") && (HappySimplaMagnify(c(this)[0], r),
                        o.css("display", "none"),
                        s.remove())
                    })
                }),
            ...
            "ha-event-calendar.default": function(_) {
                        ...
                        if ("yes" == k) {
                            var t = function(e) {
                              ...
                              , n = function(e) {
                                ...
                                return t = (e = e).getHours(),
                                n = e.getMinutes(),
                                (e = new Date).setHours(t),
                                e.setMinutes(n),
                                t = {},
                                a.includes("H") ? (t.hour = "2-digit",
                                t.hour12 = !1) : (t.hour = "numeric",
                                t.hour12 = !0,
                                (a.includes("a") || a.includes("A")) && (t.hour = "numeric")),
                                t.minute = "2-digit",
                                n = new Intl.DateTimeFormat("en-US",t).format(e),
                                n = a.includes("a") ? n.toLowerCase() : n
                            }
                              , a = (e.jsEvent.preventDefault(),
                            ...
                            p.css("display", "none"),
                            v.css("display", "none"),
                            x.addClass("ha-ec-popup-ready"),
                            h && (w.removeAttr("style"),
                            w.find("img").attr("src", h),
                            w.find("img").attr("alt", i)),
                            i && (u.removeAttr("style"),
                            u.text(i)),
                            r && (f.removeAttr("style"),
                            f.find("span.ha-ec-event-guest").text(r)),
                            l && (g.removeAttr("style"),
                            g.find("span.ha-ec-event-location").text(l)),
                            d && (p.removeAttr("style"),
                            p.html(d)),
                            !0 !== a ? (m.removeAttr("style"),
                            o = Date.parse(t(o)),
                            s = Date.parse(t(s)),
                            h = n(t(o), C),
                            w = "Invalid Data",
                            o < s && (w = n(t(s), C)),
                            m.find("span.ha-ec-event-time").text(h + " - " + w)) : (m.removeAttr("style"),
                            m.find("span.ha-ec-event-time").text(S)),
                            c && (v.removeAttr("style"),
                            v.attr("href", c),
                            "on" === e.event.extendedProps.external && v.attr("target", "_blank"),
                            "on" === e.event.extendedProps.nofollow) && v.attr("rel", "nofollow")
                        } else {
                            var y, b;
                            if (e.event.url && e.event.extendedProps.external)
                                return e.jsEvent.preventDefault(),
                                u = _.data("id"),
                                (i = document.createElement("a")).id = "happy-even-calender-link-" + u,
                                i.href = e.event.url,
                                i.target = e.event.extendedProps.external ? "_blank" : "_self",
                                i.rel = e.event.extendedProps.nofollow ? "nofollow noreferer" : "",
                                i.style.display = "none",
                                document.body.appendChild(i),
                                (y = document.getElementById(i.id)).click(),
                ...
                _.find(".ha-ec-popup-wrapper").on("click", function(e) {
                    e.stopPropagation(),
                    e.target !== e.currentTarget && e.target != t[0] && e.target != t.find(".eicon-editor-close")[0] || x.addClass("ha-ec-popup-removing").removeClass("ha-ec-popup-ready")
                }))
            },
            "ha-mailchimp.default": function(e) {
                ...
                n.on("submit", function(e) {
                    ...
                    c.ajax({
                        ...
                        success: function(e) {
                            n.trigger("reset"),
                            e.status ? (a.removeClass("error"),
                            a.addClass("success"),
                            a.text(i)) : (a.addClass("error"),
            ...
            "ha-image-accordion.default": function(e) {
                ...
                e.hasClass("ha-image-accordion-click") && (n = e.find(".ha-ia-item")).each(function(e, t) {
                    c(this).on("click", function(e) {
                        c(this).hasClass("active") || (n.removeClass("active"),
            ...
            "ha-content-switcher.default": function(e) {
                ...
                "button" == l.data("design-type") ? (n = l.find(".ha-cs-button"),
                ...
                s = l.find(".ha-cs-content-section.primary"),
                r = l.find(".ha-cs-content-section.secondary"),
                e.on("click", function(e) {
                    (t.is(":checked") ? (i.removeClass("active"),
                    s.removeClass("active"),
                    o.addClass("active"),
                    r) : (o.removeClass("active"),
            ...
            "ha-member.default": function(e) {
                var t, n = e.find(".ha-btn"), a = e.find(".ha-member-lightbox");
                0 < a.length && (t = a.find(".ha-member-lightbox-close"),
                n.on("click", function() {
        ...
        elementorFrontend.hooks.addAction("frontend/element_ready/ha-navigation-menu.default", function(e) {
            ...
            function t() {
                jQuery(window).width() < 768 ? (a.removeClass("ha-navigation-menu-wrapper"),
            ...
            a.find(".ha-menu-toggler").on("click", function(e) {
                var t = c(this).data("humberger")
                  , n = a.find("ul.menu");
                "open" == t ? (c(".ha-menu-open-icon").addClass("hide-icon"),
                c(".ha-menu-close-icon").removeClass("hide-icon"),
                c(".ha-menu-close-icon").addClass("show-icon"),
                n.slideDown()) : (c(".ha-menu-close-icon").addClass("hide-icon"),
                c(".ha-menu-open-icon").removeClass("hide-icon"),
                c(".ha-menu-open-icon").addClass("show-icon"),
                n.slideUp())
            }),
            t(),
            r.on("resize", l(t, 100))
        ...
        elementorFrontend.hooks.addAction("frontend/element_ready/ha-age-gate.default", function(e, t) {
            var n, a, i, o, s;
            elementorFrontend.isEditMode() ? (localStorage.removeItem("ha-age-gate-expire-time"),
            e.find(".ha-age-gate-wrapper").length && "no" == e.find(".ha-age-gate-wrapper").data("editor_mood") && e.find(".ha-age-gate-wrapper").hide()) : elementorFrontend.isEditMode() || (a = (n = e.find(".ha-age-gate-wrapper")).data("age_gate_cookies_time"),
            i = localStorage.getItem("ha-age-gate-expire-time"),
            n.closest("body").css("overflow", "hidden"),
            o = new Date,
            (s = new Date).setDate(o.getDate() + a),
            "" != i && null != i && new Date(o) <= new Date(i) ? (t(".ha-age-gate-wrapper").hide(),
            n.closest("body").css("overflow", "")) : ("" != i && null != i && new Date(o) > new Date(i) && localStorage.removeItem("ha-age-gate-expire-time"),
            t(".ha-age-gate-wrapper").show()),
            e.find(".ha-age-gate-wrapper.ha-age-gate-confirm-age").length && t(".ha-age-gate-confirm-age-btn").on("click", function() {
                localStorage.setItem("ha-age-gate-expire-time", s),
            ...
            e.find(".ha-age-gate-wrapper.ha-age-gate-confirm-dob").length && t(".ha-age-gate-confirm-dob-btn").on("click", function() {
                ...
                o.getFullYear() - e < t(this).closest(".ha-age-gate-wrapper").data("userbirth") ? t(this).closest(".ha-age-gate-boxes").find(".ha-age-gate-warning-msg").show() : (localStorage.setItem("ha-age-gate-expire-time", s),
                t(this).closest(".ha-age-gate-wrapper").hide(),
                t(this).closest("body").css("overflow", ""))
            }),
